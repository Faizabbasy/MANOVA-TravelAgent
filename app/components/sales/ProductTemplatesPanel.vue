...
/** Tab "Product Templates" — Menu Sales > Produk & Costing (Penyederhanaan 7-Role/Menu). Dulu
 * `/product-planning`, kini tab dalam satu menu bersama Cost Sheets — logika tidak diubah. */
