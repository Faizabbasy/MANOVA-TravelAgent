...
/** Tab "Opportunities" — Menu Sales > Pipeline (Penyederhanaan 7-Role/Menu). Dulu `/crm/opportunities`,
 * kini tab dalam satu menu Pipeline bersama Funnel/Leads/Quotation — logika tidak diubah, hanya dipindah. */
