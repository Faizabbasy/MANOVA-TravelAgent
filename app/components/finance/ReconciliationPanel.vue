...
/**
 * Tab "Reconciliation" — Menu Finance & ACC > Pembayaran & Rekonsiliasi (Penyederhanaan 7-Role/Menu).
 * Dulu `/finance/reconciliation`, kini tab dalam satu menu bersama Payments — logika tidak diubah.
 * Worklist mock murni (D-006, bukan reconciliation engine nyata) — Supplier Invoice yang `matchStatus`
 * eksplisit `unmatched`/`disputed`, dengan aksi manual "Mark Matched" dan "Flag Disputed".
 */
