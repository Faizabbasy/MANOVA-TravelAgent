...
/** Tab "Invoice" — Menu Finance & ACC > Invoice & Piutang (Penyederhanaan 7-Role/Menu). Dulu `/finance/invoices`
 * (halaman sendiri), kini tab dalam satu menu bersama AR Aging/Credit & Debit Note — logika tidak diubah. */
