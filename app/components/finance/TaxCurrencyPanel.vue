...
/** Tab "Tax & Currency" — Menu Finance & ACC > Buku Besar (Penyederhanaan 7-Role/Menu). Dulu
 * `/finance/tax`, kini tab dalam satu menu bersama Jurnal & Saldo — logika tidak diubah. */
