...
/**
 * Tab "Documents" — Menu Client Portal > Documents & Support (Penyederhanaan 7-Role/Menu). Dulu
 * `/client/documents`, kini tab dalam satu menu bersama Messages/Support — logika tidak diubah. Reuse
