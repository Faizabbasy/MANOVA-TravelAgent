...
/**
 * Tab "Support" — Menu Client Portal > Documents & Support (Penyederhanaan 7-Role/Menu). Dulu
 * `/client/support`, kini tab dalam satu menu bersama Documents/Messages — logika tidak diubah.
 * `SupportTicket` (Section 1 foundation) SENGAJA terpisah dari `Incident` internal (audit trail
 * operasional) — lihat komentar `app/types/support.ts`.
 */
