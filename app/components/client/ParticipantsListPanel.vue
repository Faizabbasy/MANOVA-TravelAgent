...
/**
 * Tab "Participants" — Menu Client Portal > My Trips (Penyederhanaan 7-Role/Menu). Dulu `/client/participants`,
 * kini tab dalam satu menu bersama Projects/Itineraries/Reservations/Trip Center/Change Requests — logika
 * tidak diubah. Agregasi lintas seluruh Project Order company. Edit detail lengkap tetap di
...
<template>
  <div class="space-y-6">
    <div v-if="canView('client-portal')" class="flex justify-end gap-2">
