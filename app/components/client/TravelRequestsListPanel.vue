...
/**
 * Tab "Travel Requests" — Menu Client Portal > Request & Approval (Penyederhanaan 7-Role/Menu). Dulu
 * `/client/travel-requests`, kini tab dalam satu menu bersama Quotations/Approvals — logika tidak diubah.
 */
