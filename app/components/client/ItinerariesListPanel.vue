...
/**
 * Tab "Itineraries" — Menu Client Portal > My Trips (Penyederhanaan 7-Role/Menu). Dulu `/client/itineraries`,
 * kini tab dalam satu menu bersama Projects/Participants/Reservations/Trip Center/Change Requests — logika
 * tidak diubah. Satu baris per Project Order yang punya itinerary — detail lengkap (versioning/compare/
 * comment/approve) di `/client/itineraries/:projectId`.
 */
