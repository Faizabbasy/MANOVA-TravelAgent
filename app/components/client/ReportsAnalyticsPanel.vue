...
/**
 * Tab "Reports" — Menu Client Portal > Reports & Feedback (Penyederhanaan 7-Role/Menu). Dulu
 * `/client/reports`, kini tab dalam satu menu bersama Feedback — logika tidak diubah. Seluruh angka murni
 * derivasi `getClientReportSummary` (agregasi di atas Project/Invoice/Traveler/ChangeRequest/SupportTicket/
 * Feedback existing) — TIDAK ADA dataset laporan paralel.
 */
...
<template>
  <div class="space-y-6">
    <div v-if="canView('client-portal')" class="flex items-center justify-end gap-2 print:hidden">
