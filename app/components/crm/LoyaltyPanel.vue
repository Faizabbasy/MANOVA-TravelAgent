...
/** Tab "Loyalty" — Menu CRM > Engagement (Penyederhanaan 7-Role/Menu). Dulu `/crm/loyalty`, kini tab
 * dalam satu menu bersama Follow-up/Review & Feedback — logika tidak diubah. */
