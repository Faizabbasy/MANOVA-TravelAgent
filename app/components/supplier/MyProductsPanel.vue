...
/** Tab "Produk/Layanan" — Menu Vendor Portal > Katalog (Penyederhanaan 7-Role/Menu). Dulu
 * `/supplier/products`, kini tab dalam satu menu bersama Komoditas Saya — logika tidak diubah. */
