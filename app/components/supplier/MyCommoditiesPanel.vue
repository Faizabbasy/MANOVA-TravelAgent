...
/** Tab "Komoditas" — Menu Vendor Portal > Katalog (Penyederhanaan 7-Role/Menu). Dulu
 * `/supplier/commodities`, kini tab dalam satu menu bersama Produk/Layanan — logika tidak diubah. */
