 ...
 * internalnya sendiri (Directory/Access Review, plain ref — tidak query-synced). */
...
/** Users vs Access Review (Section 23) — tab tambahan, aditif ke UI list+search+role-switch existing di bawah. */
...
/**
 * Daftar modul untuk ringkasan akses di dialog detail user. Diturunkan dari `MODULES`
 * (`app/constants/modules.ts`) sehingga selalu ikut ketika modul bertambah/berubah.
 */
...
/**
 * Suspend/reactivate (Section 23, D-080, Wajib "Access review and suspended user state"). Alasan WAJIB
 * saat suspend — pola sama seluruh transisi destruktif lain di codebase ini (mandatory-reason).
 */
          ...
          <div v-if="selectedUser" class="space-y-4">
            ...
            <div v-if="canManageUsers" class="space-y-1.5">
              ...
              <p class="text-xs text-muted-foreground">
                Konfigurasi permission tiap role diatur di tab
                <span class="text-primary">Roles and Permissions</span>.
              </p>
            </div>
