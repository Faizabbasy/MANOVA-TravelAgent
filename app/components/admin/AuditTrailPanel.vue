...
/** Tab "Audit Trail" — Menu Administration > Audit & Activity (Penyederhanaan 7-Role/Menu). Dulu
 * `/admin/audit-trail`, kini tab dalam satu menu bersama Activity Center — logika tidak diubah. */
...
/**
 * Free-text search (Section 23, D-080, Wajib "Audit trail search"). Aditif ke 3 filter dropdown existing.
...
// Log Sistem (Non-Project) — SystemEvent, module 'administration' dkk. Search-only, TIDAK punya 3 filter dropdown existing.
