...
/** Tab "Roles and Permissions" — Menu Administration > Users & Roles (Penyederhanaan 7-Role/Menu). Dulu
 * `/admin/roles`, kini tab dalam satu menu bersama Users — logika tidak diubah, termasuk sub-tab
 * internalnya sendiri (Modules/Menus/Action Flags/Users/Preview, plain ref — tidak query-synced). */
      ...
      <Dialog v-model:open="isResetOpen">
        <DialogContent class="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Seluruh role custom dihapus dan grant 7 role bawaan dikembalikan ke kondisi seed. Penugasan
