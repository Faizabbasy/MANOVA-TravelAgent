...
/** Tab "Data Vendor" — Menu Vendor & Partner > Data Vendor (Penyederhanaan 7-Role/Menu). Dulu `/vendors`
 * (halaman ini sendiri), kini tab dalam satu menu bersama Rating & Performance — logika tidak diubah. */
