...
/** Tab "Accommodation" — Menu Operations > Service Operations (Penyederhanaan 7-Role/Menu). Dulu
 * `/accommodation` (list), kini tab dalam satu menu bersama Ticketing/Transportation/MICE. Route detail
 * `/accommodation/[id]` TIDAK berubah. */
...
<template>
  <div class="space-y-6">
    ...
    <RoleAccessState v-if="!canView('accommodation')" module-label="modul Service Operations" />
