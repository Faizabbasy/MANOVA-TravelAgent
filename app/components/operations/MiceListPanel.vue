...
/** Tab "MICE" — Menu Operations > Service Operations (Penyederhanaan 7-Role/Menu). Dulu `/mice` (list),
 * kini tab dalam satu menu bersama Ticketing/Accommodation/Transportation. Route detail `/mice/[id]`
 * TIDAK berubah. */
