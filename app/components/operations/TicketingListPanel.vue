...
/** Tab "Ticketing" — Menu Operations > Service Operations (Penyederhanaan 7-Role/Menu). Dulu `/ticketing`
 * (list), kini tab dalam satu menu bersama Accommodation/Transportation/MICE. Route detail `/ticketing/[id]`
 * TIDAK berubah. Query `?projectId=&create=1` (quick-create dari Project Detail) tetap dibaca dari sini. */
...
<template>
  <div class="space-y-6">
    ...
    <RoleAccessState v-if="!canView('ticketing')" module-label="modul Service Operations" />
