...
/**
 * Booking & Service Order Center — Timeline (Section 18, D-075). Consolidation/orchestration LAYER di atas
 * Flight/Hotel/Transport/MICE booking (Section 13-16) — SATU sumber kebenaran seluruh service (acceptance
 * literal), BUKAN entitas komersial baru. Lihat `docs/frontend-known-issues.md` bagian 13 untuk disambiguasi
 * eksplisit dari `ServiceOrder` Procurement (Section 17, `/procurement`).
 */

definePageMeta({ layout: 'dashboard', middleware: 'auth' })
useHead({ title: 'Booking & Service Order Center' })
...
<template>
  <div class="space-y-6">
    <PageHeader
      title="Booking & Service Order Center"
      description="Satu timeline konsolidasi Flight/Hotel/Transport/MICE — booking reference, hold/confirm/deadline, voucher, status internal/supplier/client, dependency, payment gate, dan exception."
      :breadcrumb="[{ label: 'Booking & Service Order Center' }]"
    >
      <template #actions>
