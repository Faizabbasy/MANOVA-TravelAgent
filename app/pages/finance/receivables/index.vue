...
useHead({ title: 'Receivables (AR) — Finance & ACC' })
...
<template>
  <div class="space-y-6">
    <PageHeader
      ...
      description="Piutang klien beserta umurnya, diturunkan langsung dari invoice dan pembayaran yang tercatat."
      :breadcrumb="[{ label: 'Finance & ACC', to: '/finance' }, { label: 'Receivables' }]"
    />
    ...
    <template v-else>
      ...
      <SectionCard title="Ringkasan Hutang (AP)" description="Rincian lengkap tersedia di halaman Payables.">
