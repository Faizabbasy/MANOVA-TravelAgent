          ...
          <div class="flex items-start justify-between border-b border-border pb-6 mb-6">
            <div>
              ...
              <p class="text-xs text-muted-foreground">
                Travel Agent B2B — Transportation Service Order (Mock)
              </p>
            </div>
          ...
          <div v-if="selectedOption" class="grid grid-cols-2 gap-6 mb-6 text-sm">
            <div>
              ...
              <p class="text-foreground">
                {{ findStatusOption(VEHICLE_TYPES, selectedOption.vehicleType).label }} — {{ selectedOption.capacity }} pax
              </p>
              <p v-if="selectedOption.luggageCapacity" class="text-muted-foreground">
                Bagasi: {{ selectedOption.luggageCapacity }}
              </p>
