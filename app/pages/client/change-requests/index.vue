...
/**
 * Change Requests — List (Repair Phase Section 5 — Execution & Changes, Master Prompt bagian B). Draft
 * ("Save draft") DISIMPAN TERPISAH dari `ChangeRequest` nyata (`ChangeRequestDraft`, lihat komentar tipe) —
 * tidak pernah muncul di `/changes` internal sampai disubmit lewat `submitChangeRequestDraft`.
 */
definePageMeta({ layout: 'dashboard', middleware: 'auth' })
useHead({ title: 'Change Requests' })
...
<template>
  <div class="space-y-6">
    <PageHeader
      ...
      description="Ajukan dan pantau permintaan perubahan lintas seluruh Project Order Anda."
      :breadcrumb="[{ label: 'Client Portal', to: '/client' }, { label: 'Travel Management' }, { label: 'Change Requests' }]"
    >
      <template #actions>
