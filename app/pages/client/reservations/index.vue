...
/**
 * Reservations — List (Repair Phase Section 4 — Core Project, Wajib "Reservation monitoring"). REUSE
 * `getClientReservations` (derivasi `getBookingTimeline`/`BookingOrchestrationRecord`, Section 18 — opsi
 * (b) `docs/client-page-inventory.md` #9), TIDAK ada dataset booking paralel. Client hanya view + request
 * change lewat Change Request — TIDAK ADA aksi edit booking vendor langsung di halaman ini.
 */
...
<template>
  <div class="space-y-6">
    <PageHeader
      title="Reservations"
      description="Status reservasi Flight, Hotel, Transportation, dan MICE lintas Project Order Anda."
      :breadcrumb="[{ label: 'Client Portal', to: '/client' }, { label: 'Travel Management' }, { label: 'Reservations' }]"
    />
