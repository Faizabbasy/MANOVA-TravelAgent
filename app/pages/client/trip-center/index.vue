...
/**
 * Trip Center — Index (Repair Phase Section 5 — Execution & Changes, Master Prompt bagian 10). Daftar
 * Project Order company Anda dikelompokkan menurut mode (Pre-departure/Active/Trip Completed, derivasi
 * `getTripCenterMode`) — halaman detail penuh di `/client/trip-center/[projectId]`.
 */
definePageMeta({ layout: 'dashboard', middleware: 'auth' })
useHead({ title: 'Trip Center' })
...
<template>
  <div class="space-y-6">
    <PageHeader
      title="Trip Center"
      description="Pusat informasi pra-keberangkatan, saat perjalanan, dan pasca-trip untuk setiap Project Order Anda."
      :breadcrumb="[{ label: 'Client Portal', to: '/client' }, { label: 'Travel Management' }, { label: 'Trip Center' }]"
    />
