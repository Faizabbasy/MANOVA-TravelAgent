...
useHead({ title: 'Booking Calendar & Map — Operations' })
...
const activeTab = ref<'calendar' | 'map'>('calendar')
...
<template>
  <div class="space-y-6">
    <PageHeader
      title="Booking Calendar & Map"
      description="Kalender gabungan seluruh jadwal operasional, plus perencanaan lokasi berbasis peta."
      :breadcrumb="[{ label: 'Operations & Scheduling' }, { label: 'Calendar & Map' }]"
    />
