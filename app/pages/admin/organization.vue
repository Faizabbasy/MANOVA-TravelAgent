...
/**
 * Organization Profile (Section 23 — Administration, Master Data dan Audit, roadmap Section 00–24 baru,
 * D-080). Singleton — profil perusahaan travel agency itu sendiri (BUKAN multi-tenancy, judgment call
 * eksplisit didokumentasikan D-080, tidak ada indikasi sistem multi-tenant di 22 section sebelumnya).
 * Discoverable dari `/admin` hub (kartu ke-5) dan nav child Administration ke-5.
 */

definePageMeta({ layout: 'dashboard', middleware: 'auth' })
useHead({ title: 'Organization Profile — Administration' })
...
<template>
  <div class="space-y-6">
    <PageHeader
      ...
      description="Profil perusahaan travel agency (singleton) — bukan pengaturan multi-tenant/company lain."
      :breadcrumb="[{ label: 'Administration', to: '/admin' }, { label: 'Organization Profile' }]"
    />
