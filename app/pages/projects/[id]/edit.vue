...
const projectData: Record<string, any> = {
  'PRJ-001': {
    id: 'PRJ-001', name: 'E-commerce Platform Redesign',
    ...
    contractValue: 58000, budget: 45000,
    startDate: '2024-11-01', dueDate: '2025-02-15',
  },
  'PRJ-002': {
    id: 'PRJ-002', name: 'Mobile Banking App',
    ...
    contractValue: 110000, budget: 85000,
    startDate: '2024-09-01', dueDate: '2025-01-30',
  },
  'PRJ-003': {
    id: 'PRJ-003', name: 'Healthcare Portal',
    ...
    contractValue: 78000, budget: 62000,
    startDate: '2024-10-15', dueDate: '2025-03-20',
  },
  'PRJ-004': {
    id: 'PRJ-004', name: 'SaaS Analytics Dashboard',
    ...
    contractValue: 52000, budget: 38000,
    startDate: '2025-01-15', dueDate: '2025-04-10',
  },
}
...
function priorityDot(val: string) {
  return val === 'critical' ? 'bg-destructive'
       : val === 'high'     ? 'bg-warning'
       : val === 'medium'   ? 'bg-primary'
       : 'bg-muted-foreground'
}
...
<template>
  ...
  <div v-if="notFound" class="flex flex-col items-center justify-center py-24 gap-4">
    ...
    <NuxtLink to="/projects" class="text-sm text-primary hover:underline">← Back to Projects</NuxtLink>
  </div>
  ...
  <div v-else class="max-w-3xl mx-auto py-2 pb-12">
    ...
    <div class="mb-8 flex items-start justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-foreground">Edit Project</h1>
            ...
            <div class="space-y-2">
              ...
              <div class="space-y-2">
                <div v-for="(_, i) in form.objectives" :key="i" class="flex items-center gap-2 group">
                  <div class="flex items-center justify-center w-5 h-5 rounded-full bg-primary/10 text-primary text-[10px] font-bold shrink-0">{{ i + 1 }}</div>
                  <input
          ...
          <div class="space-y-5">
            ...
            <div v-if="isDirty" class="flex items-start gap-2.5 rounded-xl border border-warning/30 bg-warning/5 p-4">
              ...
              <div class="text-xs text-muted-foreground leading-relaxed">
                ...
                <button type="button" @click="handleDiscard" class="text-warning hover:underline font-medium cursor-pointer">Discard changes</button>
