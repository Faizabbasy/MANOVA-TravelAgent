            ...
            <div class="space-y-3">
              ...
              <div class="space-y-1">
                ...
                <p class="text-xs text-muted-foreground">
                  {{ allExpenses.filter(e => e.status === 'paid').length }} transactions cleared
                </p>
              </div>
            </div>
          ...
          <div class="px-6 pt-6 pb-5 border-b border-border">
            <div class="flex items-start justify-between gap-4 pr-6">
              <div>
                ...
                <h2 class="text-lg font-bold text-foreground leading-tight">
