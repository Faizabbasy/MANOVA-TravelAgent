          ...
          <div class="flex items-start justify-between border-b border-border pb-6 mb-6">
            <div>
              ...
              <p class="text-xs text-muted-foreground">
                Travel Agent B2B — Bill of Quantities (Mock)
              </p>
            </div>
          ...
          <table class="w-full text-sm mb-6">
            ...
            <tbody>
              <tr v-for="(item, index) in event.boqItems" :key="index" class="border-b border-border/60">
                <td class="py-2 text-foreground">
                  {{ findStatusOption(MICE_BOQ_CATEGORIES, item.category).label }}
                </td>
              ...
              <tr v-if="event.boqItems.length === 0">
            ...
            <tfoot v-if="event.boqItems.length > 0">
              <tr class="border-t-2 border-border font-semibold">
                <td colspan="3" class="py-2 text-foreground">
                  Total
                </td>
                <td class="py-2 text-right text-foreground">
