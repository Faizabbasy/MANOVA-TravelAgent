...
/**
 * PDF/Print Preview (Section 05) — mockup frontend-only: TIDAK menghasilkan file PDF nyata, melainkan
 * halaman print-friendly (tanpa layout dashboard) yang dapat di-print/save-as-PDF lewat dialog print
 * browser (`window.print()`), sesuai batasan protokol (dilarang integrasi/generator PDF produksi).
 */
        ...
        <div class="rounded-xl border border-border bg-card p-8 shadow-sm print:rounded-none print:border-0 print:shadow-none print:p-0">
          ...
          <div class="flex justify-end mb-6">
            <div class="w-64 space-y-1.5 text-sm">
              ...
              <div v-if="quotation.markupIdr" class="flex justify-between text-muted-foreground">
                <span>Markup</span><span>{{ formatCurrencyIdr(quotation.markupIdr) }}</span>
              </div>
