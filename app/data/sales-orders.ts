...
export const SALES_ORDERS: SalesOrder[] = reactive([
  ...
  /** Demo Client Presentation — hero Group Trip B2C `PRJ-502` (Labuan Bajo Komodo Explorer), 3 booking `paid` menjadi 6 Traveler (`app/data/projects.ts` TRV-5021..5026), pola sama SLO-006/009. */
  { id: 'SLO-011', customerId: 'PTY-016', projectId: 'PRJ-502', destination: 'Labuan Bajo & Pulau Komodo, Indonesia', travelStartDate: '2026-07-09', travelEndDate: '2026-07-12', travelerCount: 2, priceIdr: 14_000_000, status: 'paid', createdAt: '2026-06-30' },
  { id: 'SLO-012', customerId: 'PTY-017', projectId: 'PRJ-502', destination: 'Labuan Bajo & Pulau Komodo, Indonesia', travelStartDate: '2026-07-09', travelEndDate: '2026-07-12', travelerCount: 3, priceIdr: 19_500_000, status: 'paid', createdAt: '2026-07-01' },
  { id: 'SLO-013', customerId: 'PTY-018', projectId: 'PRJ-502', destination: 'Labuan Bajo & Pulau Komodo, Indonesia', travelStartDate: '2026-07-09', travelEndDate: '2026-07-12', travelerCount: 1, priceIdr: 6_500_000, status: 'paid', createdAt: '2026-07-02' }
])
