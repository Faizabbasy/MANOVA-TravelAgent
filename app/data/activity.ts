...
export const ACTIVITIES: ActivityEntry[] = reactive([
  ...
  /** PRJ-104 — mengikuti pola entri `markLeadWon` untuk project yang di-seed langsung. */
  { id: 'ACT-1041', projectId: 'PRJ-104', message: 'Project PRJ-104 dibuat dari Lead LED-018 (Won oleh Sari Wijaya/Management)', isChange: false, reviewed: true, createdAt: '2026-07-24' },
 ...
 * `entityId` merujuk ID entitas sumber yang sudah ada (`LEADS`/`QUOTATIONS`/`PARTIES`/
...
export const SYSTEM_EVENTS: SystemEvent[] = reactive([
  ...
  { id: 'EVT-002', module: 'lead', type: 'lead-qualified', message: 'Lead LED-009 "Manila Business Trip Q3 2026" di-qualify', entityId: 'LED-009', userId: 'USR-001', createdAt: '2026-06-10' },
  ...
  { id: 'EVT-004', module: 'lead', type: 'lead-won', message: 'Lead LED-009 ditandai Won', entityId: 'LED-009', userId: 'USR-003', createdAt: '2026-06-25' },
  ...
  { id: 'EVT-006', module: 'project-order', type: 'project-order-created', message: 'Project Order PRJ-101 dibuat dari Lead LED-009', entityId: 'PRJ-101', createdAt: '2026-06-25' },
  ...
  { id: 'EVT-016', module: 'quotation', type: 'quotation-created', message: 'Quotation QUO-005 "Bali Team Building 2026" dibuat untuk Lead LED-005', entityId: 'QUO-005', userId: 'USR-001', createdAt: '2026-07-05' },
  ...
  { id: 'EVT-019', module: 'lead', type: 'lead-won', message: 'Lead LED-018 (repeat client PT Cipta Distribusi Nusantara) ditandai Won', entityId: 'LED-018', userId: 'USR-003', createdAt: '2026-07-24' },
  { id: 'EVT-020', module: 'project-order', type: 'project-order-created', message: 'Project Order PRJ-104 dibuat dari Lead LED-018 — Project Order kedua PT Cipta Distribusi Nusantara', entityId: 'PRJ-104', createdAt: '2026-07-24' },
