...
export const LEADS: Lead[] = reactive([
  {
    id: 'LED-001', name: 'CV Nirmala Eventama', companyName: 'CV Nirmala Eventama', source: 'website',
    stage: 'qualified', ownerId: 'USR-001', handedOverTo: 'USR-014',
  ...
  },
  {
    ...
    phone: '0815-7000-0002', email: 'rangga.wibowo@example.com',
    createdAt: '2026-07-24', lastUpdatedAt: '2026-07-24', archived: false,
  },
  {
    id: 'LED-003', name: 'Siska Amelinda', companyName: 'Siska Amelinda Consulting', source: 'tiktok',
    stage: 'new', ownerId: 'USR-001',
    phone: '0815-7000-0003', email: 'siska.amelinda@example.com',
    createdAt: '2026-07-25', lastUpdatedAt: '2026-07-25', archived: false,
  },
  {
    id: 'LED-004', name: 'Doni Ferdian', companyName: 'PT Ferdian Karya Logistik', source: 'whatsapp',
    stage: 'contacted', ownerId: 'USR-001',
  ...
  },
  {
    ...
    stage: 'qualified', ownerId: 'USR-001', handedOverTo: 'USR-014',
    phone: '0815-7000-0005', email: 'nadia.ramadhani@example.com',
    qualificationNotes: 'Referral dari client existing PTY-001, langsung diarahkan ke AE untuk Bali Team Building.',
    expectedCloseDate: '2026-08-03', createdAt: '2026-07-04', lastUpdatedAt: '2026-07-18', archived: false,
    partyId: 'PTY-004', opportunityId: 'OPP-005',
  },
  {
    id: 'LED-006', name: 'Wahyu Setiadi', companyName: 'CV Setiadi Jaya', source: 'event',
    stage: 'unqualified', ownerId: 'USR-001',
    qualificationNotes: 'Hanya menanyakan brosur saat pameran, tidak ada budget/timeline konkret.',
    createdAt: '2026-07-12', lastUpdatedAt: '2026-07-14', archived: false,
  },
  {
    id: 'LED-007', name: 'Yuni Kartika', companyName: 'Yuni Kartika Personal', source: 'email',
    stage: 'new', ownerId: 'USR-001',
    email: 'yuni.kartika@example.com',
    createdAt: '2026-07-27', lastUpdatedAt: '2026-07-27', archived: false,
  },
  {
    id: 'LED-008', name: 'Made Surya', companyName: 'PT Surya Perkasa', source: 'sales-outreach',
    stage: 'contacted', ownerId: 'USR-001',
    phone: '0815-7000-0008',
    qualificationNotes: 'Hasil cold outreach Sales, sudah dijadwalkan panggilan lanjutan.',
    createdAt: '2026-07-20', lastUpdatedAt: '2026-07-25', archived: false,
  },
  {
    id: 'LED-009', name: 'Hendra Wijaya', companyName: 'PT Cipta Distribusi Nusantara', source: 'website',
    stage: 'qualified', ownerId: 'USR-001', handedOverTo: 'USR-014',
    createdAt: '2026-06-05', lastUpdatedAt: '2026-06-10', archived: false,
    partyId: 'PTY-001', opportunityId: 'OPP-001',
  },
  {
    id: 'LED-010', name: 'Toni Gunawan', companyName: 'UD Gunawan Sejahtera', source: 'other',
    stage: 'unqualified', ownerId: 'USR-001',
