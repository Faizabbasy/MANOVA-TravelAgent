...
export const EMPLOYEES: Employee[] = reactive([
  ...
  { id: 'EMP-002', name: 'Galih Ramadhan', position: 'Account Executive', department: 'Sales', employmentType: 'full-time', status: 'active', joinedAt: '2022-08-15', baseSalaryIdr: 12_000_000, commissionRatePercent: 2.5, phone: '0812-1111-2202', email: 'galih.ramadhan@manova.id' },
  ...
  { id: 'EMP-004', name: 'Fitri Handayani', position: 'Project Manager', department: 'Operations', employmentType: 'full-time', status: 'active', joinedAt: '2022-01-10', baseSalaryIdr: 14_000_000, commissionRatePercent: 1.5, phone: '0812-1111-2204', email: 'fitri.handayani@manova.id' },
  { id: 'EMP-005', name: 'Fajar Nugroho', position: 'Operations Coordinator', department: 'Operations', employmentType: 'full-time', status: 'active', joinedAt: '2023-01-09', baseSalaryIdr: 10_500_000, phone: '0812-1111-2205', email: 'fajar.nugroho@manova.id' },
  { id: 'EMP-006', name: 'Andi Pratama', position: 'Ticketing Specialist', department: 'Operations', employmentType: 'full-time', status: 'active', joinedAt: '2023-05-02', baseSalaryIdr: 8_500_000, phone: '0812-1111-2206', email: 'andi.pratama@manova.id' },
  { id: 'EMP-007', name: 'Maya Putri', position: 'Accommodation Specialist', department: 'Operations', employmentType: 'full-time', status: 'on-leave', joinedAt: '2023-07-17', baseSalaryIdr: 8_500_000, phone: '0812-1111-2207', email: 'maya.putri@manova.id' },
  { id: 'EMP-008', name: 'Lina Marlina', position: 'MICE Coordinator', department: 'Operations', employmentType: 'full-time', status: 'active', joinedAt: '2022-11-21', baseSalaryIdr: 11_000_000, phone: '0812-1111-2208', email: 'lina.marlina@manova.id' },
  ...
  { id: 'EMP-010', name: 'Wulan Kartika', position: 'Procurement Officer', department: 'Vendor & Partner', employmentType: 'full-time', status: 'active', joinedAt: '2023-09-04', baseSalaryIdr: 9_000_000, phone: '0812-1111-2210', email: 'wulan.kartika@manova.id' },
  { id: 'EMP-011', name: 'Citra Ayu Lestari', position: 'Marketing Specialist', department: 'Marketing', employmentType: 'contract', status: 'active', joinedAt: '2024-02-01', baseSalaryIdr: 8_000_000, phone: '0812-1111-2211', email: 'citra.lestari@manova.id' },
  { id: 'EMP-012', name: 'Bayu Aditama', position: 'HR Generalist', department: 'HR', employmentType: 'full-time', status: 'active', joinedAt: '2023-04-03', baseSalaryIdr: 9_800_000, phone: '0812-1111-2212', email: 'bayu.aditama@manova.id' },
...
export const PERFORMANCE_REVIEWS: PerformanceReview[] = reactive([
  ...
  { id: 'PRV-005', employeeId: 'EMP-001', period: '2026-H1', reviewerId: 'USR-001', deliveryScore: 4, qualityScore: 3, collaborationScore: 4, initiativeScore: 4, overallScore: 3.75, strengths: 'Aktif mencari lead baru dari berbagai kanal.', improvements: 'Kualifikasi lead perlu lebih ketat agar konversi naik.', reviewedAt: '2026-07-10' }
])
