...
export const VENDOR_QUOTATIONS: VendorQuotation[] = reactive([
  ...
  /** PRJ-501/502 (Demo Client Presentation) — vendor↔project↔service linkage nyata untuk tab Vendors, 2 vendor berbeda per hero project. */
  { id: 'VQ-013', vendorId: 'VND-001', projectId: 'PRJ-501', serviceId: 'SVC-5011', serviceType: 'flight', amountIdr: 78_000_000, status: 'accepted', submittedAt: '2026-06-28' },
  { id: 'VQ-014', vendorId: 'VND-002', projectId: 'PRJ-501', serviceId: 'SVC-5012', serviceType: 'hotel', amountIdr: 88_000_000, status: 'accepted', submittedAt: '2026-06-29' },
  { id: 'VQ-015', vendorId: 'VND-003', projectId: 'PRJ-502', serviceId: 'SVC-5021', serviceType: 'transportation', amountIdr: 15_000_000, status: 'accepted', submittedAt: '2026-07-04' },
  { id: 'VQ-016', vendorId: 'VND-002', projectId: 'PRJ-502', serviceId: 'SVC-5022', serviceType: 'hotel', amountIdr: 13_000_000, status: 'accepted', submittedAt: '2026-07-04' }
])
