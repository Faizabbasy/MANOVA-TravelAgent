...
export const PROJECT_MILESTONES: ProjectMilestone[] = reactive([
  ...
  { id: 'PMS-102-2', projectId: 'PRJ-102', stepKey: 'drafting', name: 'Survey & Assessment Venue', plannedDate: '2026-07-05', actualDate: '2026-07-14', ownerId: 'USR-002', status: 'completed', note: 'Venue pertama tidak tersedia, harus survey ulang.' },
  { id: 'PMS-102-3', projectId: 'PRJ-102', stepKey: 'drafting', name: 'Finalisasi Itinerary', plannedDate: '2026-07-20', ownerId: 'USR-002', status: 'delayed', note: 'Menunggu keputusan klien atas opsi venue kedua.' },
  ...
  { id: 'PMS-102-5', projectId: 'PRJ-102', stepKey: 'confirmed', name: 'Konfirmasi Vendor & Booking', plannedDate: '2026-08-05', ownerId: 'USR-002', status: 'not-started' },
  { id: 'PMS-102-6', projectId: 'PRJ-102', stepKey: 'start', name: 'Dokumen Traveler Lengkap', plannedDate: '2026-08-20', ownerId: 'USR-002', status: 'not-started' },
  { id: 'PMS-102-7', projectId: 'PRJ-102', stepKey: 'departure', name: 'Keberangkatan', plannedDate: '2026-09-08', ownerId: 'USR-002', status: 'not-started' },
  { id: 'PMS-102-8', projectId: 'PRJ-102', stepKey: 'done', name: 'Laporan Akhir & Review Klien', plannedDate: '2026-09-22', ownerId: 'USR-002', status: 'not-started' },
  ...
  { id: 'PMS-103-2', projectId: 'PRJ-103', stepKey: 'drafting', name: 'Procurement Assessment', plannedDate: '2026-06-01', actualDate: '2026-06-04', ownerId: 'USR-002', status: 'completed' },
  ...
  { id: 'PMS-103-4', projectId: 'PRJ-103', stepKey: 'confirmed', name: 'Konfirmasi Vendor & Booking', plannedDate: '2026-07-01', actualDate: '2026-07-06', ownerId: 'USR-002', status: 'completed' },
...
export const PROJECT_NOTES: ProjectNote[] = reactive([
  ...
  { id: 'PNT-003', projectId: 'PRJ-102', authorId: 'USR-002', body: 'Venue opsi kedua (Yas Island) menunggu keputusan klien. Ini penghambat utama finalisasi itinerary.', createdAt: '2026-07-26', pinned: true },
  { id: 'PNT-004', projectId: 'PRJ-103', authorId: 'USR-002', body: 'Rundown final sudah disetujui klien. Staffing lengkap kecuali 1 slot LO cadangan.', createdAt: '2026-07-28' }
])
