...
export const HOTEL_BOOKINGS: HotelBooking[] = reactive([
  ...
  {
    id: 'HTL-1022', projectId: 'PRJ-102', serviceId: 'SVC-1022', status: 'amended',
    options: [
    ...
    roomsBlocked: 9,
    checkInDate: '2026-09-22', checkOutDate: '2026-09-26',
    ...
    netCostIdr: 129_600_000, sellPriceIdr: 152_900_000,
    createdAt: '2026-06-15', updatedAt: '2026-09-05',
  },
  // PRJ-102 — Room Block B (3 pax) digabung ke Block A, dibatalkan setelah deadline — mendemokan penalty.
  {
    id: 'HTL-1023', projectId: 'PRJ-102', serviceId: 'SVC-1023', status: 'cancelled',
    options: [
    ...
    createdAt: '2026-06-15', updatedAt: '2026-09-12',
  },
  // PRJ-103 — Palu, Group Management (GRP-001, 10 pax), rooming list reuse ROOM-001.
  {
    id: 'HTL-1033', projectId: 'PRJ-103', serviceId: 'SVC-1033', groupId: 'GRP-001', status: 'confirmed',
    options: [
    ...
    roomsBlocked: 5,
    checkInDate: '2026-08-10', checkOutDate: '2026-08-14',
    earlyCheckInRequested: true,
    confirmationNumber: 'PLW-2200',
    voucherIssuedAt: '2026-06-20',
    cancellationDeadline: '2026-07-25',
    netCostIdr: 54_000_000, sellPriceIdr: 63_000_000,
    createdAt: '2026-06-10', updatedAt: '2026-06-20',
  },
  // PRJ-103 — Sales Team (GRP-002, 25 pax) — masih quoted, 2 opsi property dibandingkan.
  {
    id: 'HTL-1034', projectId: 'PRJ-103', groupId: 'GRP-002', status: 'quoted',
    options: [
  ...
  {
    id: 'HTL-1035', projectId: 'PRJ-103', groupId: 'GRP-003', status: 'confirmed',
    options: [
    ...
    cancellationDeadline: '2026-07-25',
    netCostIdr: 35_200_000, sellPriceIdr: 41_000_000,
  ...
  {
    id: 'HTL-1036', projectId: 'PRJ-102', status: 'requested',
    options: [],
    travelerIds: [],
    checkInDate: '2026-09-22', checkOutDate: '2026-09-26',
