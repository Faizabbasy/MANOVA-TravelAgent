...
export const TRANSPORT_BOOKINGS: TransportBooking[] = reactive([
  ...
  {
    id: 'TRN-1034', projectId: 'PRJ-103', serviceId: 'SVC-1034', groupId: 'GRP-001', transferType: 'multi-day-charter', status: 'assigned',
    options: [
    ...
    driverName: 'Herman Wijaya', driverPhone: '0852-6600-1001',
    standbyHours: 4, tollFeeIdr: 150_000,
    netCostIdr: 5_950_000, sellPriceIdr: 7_200_000,
    createdAt: '2026-06-12', updatedAt: '2026-07-20',
  },
  // PRJ-103 — Sales Team (GRP-002, 25 pax), confirmed, mendemokan "Change" (jadwal city tour dimajukan).
  {
    id: 'TRN-1035', projectId: 'PRJ-103', groupId: 'GRP-002', transferType: 'multi-day-charter', status: 'confirmed',
    options: [
    ...
    driverName: 'Slamet Riyadi', driverPhone: '0852-6600-1002',
    tollFeeIdr: 100_000,
    hasChange: true,
    changeNote: 'Jadwal City Tour dimajukan dari 10:00 menjadi 08:00 mengikuti penyesuaian agenda MICE Conference Hari 1.',
    netCostIdr: 7_300_000, sellPriceIdr: 8_800_000,
    createdAt: '2026-06-15', updatedAt: '2026-08-05',
  },
  // PRJ-103 — Partner/VIP (GRP-003), point-to-point kepulangan, mendemokan aksesibilitas + "Incident".
  {
    id: 'TRN-1036', projectId: 'PRJ-103', groupId: 'GRP-003', transferType: 'point-to-point', status: 'completed',
    options: [
    ...
    driverName: 'Yanto Pratama', driverPhone: '0852-6600-1003',
    hasIncident: true,
    ...
    netCostIdr: 650_000, sellPriceIdr: 850_000,
    createdAt: '2026-06-20', updatedAt: '2026-08-14',
  },
  // PRJ-103 — individual, dibatalkan sebelum eksekusi (peserta memakai kendaraan pribadi).
  {
    id: 'TRN-1037', projectId: 'PRJ-103', transferType: 'airport-pickup', status: 'cancelled',
    options: [
    ...
    createdAt: '2026-06-25', updatedAt: '2026-07-30',
  },
  // PRJ-103 — permintaan tambahan (overflow day charter) untuk agenda MICE, masih tahap quote.
  {
    id: 'TRN-1038', projectId: 'PRJ-103', transferType: 'full-day-charter', status: 'quoted',
    options: [
