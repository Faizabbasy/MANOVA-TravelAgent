...
export const FLIGHT_BOOKINGS: FlightBooking[] = reactive([
  {
    id: 'FLT-1011', projectId: 'PRJ-101', serviceId: 'SVC-1011', pnr: 'MNL8201', status: 'issued',
    options: [
    ...
    netCostIdr: 75_000_000, sellPriceIdr: 95_000_000,
    createdAt: '2026-06-15', updatedAt: '2026-06-25',
  },
  {
    id: 'FLT-1021', projectId: 'PRJ-102', serviceId: 'SVC-1021', pnr: 'AUH9221', status: 'reissued',
    options: [
    ...
    netCostIdr: 58_800_000, sellPriceIdr: 72_000_000,
    ...
    createdAt: '2026-06-20', updatedAt: '2026-07-08',
  },
  {
    id: 'FLT-1031', projectId: 'PRJ-103', serviceId: 'SVC-1031', pnr: 'PLW1031A', status: 'issued',
    options: [
    ...
    netCostIdr: 6_800_000, sellPriceIdr: 8_800_000,
    createdAt: '2026-06-10', updatedAt: '2026-06-18',
  },
  {
    id: 'FLT-1032', projectId: 'PRJ-103', serviceId: 'SVC-1032', status: 'hold',
    options: [
    ...
    createdAt: '2026-07-20', updatedAt: '2026-07-27',
  },
  {
    id: 'FLT-1023', projectId: 'PRJ-102', pnr: 'AUH9245', status: 'refunded',
    options: [
    ...
    netCostIdr: 9_800_000, sellPriceIdr: 12_000_000,
    statusReason: 'Traveler mengundurkan diri karena keperluan mendesak — tiket dibatalkan dan diproses refund.',
    createdAt: '2026-06-25', updatedAt: '2026-07-15',
  },
  {
    id: 'FLT-1033', projectId: 'PRJ-103', status: 'requested',
    options: [
