...
export const OPPORTUNITIES: Opportunity[] = reactive([
  {
    ...
    ownerId: 'USR-014', estimatedValueIdr: 95_000_000, destination: 'Manila, Filipina',
  ...
  },
  {
    ...
    ownerId: 'USR-014', estimatedValueIdr: 320_000_000, destination: 'Abu Dhabi, Uni Emirat Arab',
  ...
  },
  {
    ...
    ownerId: 'USR-014', estimatedValueIdr: 1_400_000_000, destination: 'Palu, Indonesia',
  ...
  },
  {
    ...
    ownerId: 'USR-014', estimatedValueIdr: 45_000_000, destination: 'Jakarta, Indonesia',
   ...
   */
  {
    ...
    ownerId: 'USR-014', estimatedValueIdr: 150_000_000, destination: 'Bali, Indonesia',
  ...
  },
  {
    ...
    ownerId: 'USR-014', estimatedValueIdr: 200_000_000, destination: 'Abu Dhabi, Uni Emirat Arab',
   ...
   */
  {
    id: 'OPP-008', partyId: 'PTY-001', title: 'Manila Follow-up Training Q1 2027', stage: 'won',
    ownerId: 'USR-014', estimatedValueIdr: 60_000_000, destination: 'Manila, Filipina',
    travelStartDate: '2027-02-16', travelEndDate: '2027-02-18', travelerEstimate: 8,
