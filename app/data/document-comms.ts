...
export const DOCUMENT_RECORDS: Document[] = reactive([
  ...
  { id: 'DOC-C009', entityType: 'project', entityId: 'PRJ-103', projectId: 'PRJ-103', name: 'Run Sheet PRJ-103', category: 'Operational', version: 1, generatedAt: '2026-07-22', accessLevel: 'internal', sourceType: 'generated', previewRoute: '/project-orders/PRJ-103/run-sheet-preview' },
  { id: 'DOC-C010', entityType: 'project', entityId: 'PRJ-103', projectId: 'PRJ-103', name: 'Manifest PRJ-103', category: 'Travel Document', version: 1, generatedAt: '2026-07-22', accessLevel: 'client', sourceType: 'generated', previewRoute: '/project-orders/PRJ-103/manifest-preview' },
  ...
  { id: 'DOC-C012', entityType: 'party', entityId: 'PTY-001', name: 'NPWP PT Cipta Distribusi Nusantara.pdf', category: 'Legal', version: 1, uploadedAt: '2026-05-01', expiresAt: '2026-08-10', accessLevel: 'client', sourceType: 'uploaded', uploadedBy: 'USR-021', verified: true, verifiedBy: 'USR-002', verifiedAt: '2026-05-05' },
  /**
  ...
  { id: 'DOC-C014', entityType: 'traveler', entityId: 'TRV-1021', projectId: 'PRJ-102', name: 'Scan Visa TRV-1021.pdf', category: 'Travel Document', version: 1, uploadedAt: '2026-07-05', expiresAt: '2027-06-30', accessLevel: 'internal', sourceType: 'uploaded', uploadedBy: 'USR-002' },
  { id: 'DOC-C015', entityType: 'change-request', entityId: 'CR-004', projectId: 'PRJ-103', name: 'Dokumentasi Perubahan Armada CR-004.pdf', category: 'Change Documentation', version: 1, uploadedAt: '2026-07-18', accessLevel: 'internal', sourceType: 'uploaded', uploadedBy: 'USR-002' },
  { id: 'DOC-C016', entityType: 'incident', entityId: 'INC-001', projectId: 'PRJ-103', name: 'Laporan Insiden INC-001.pdf', category: 'Incident Report', version: 1, uploadedAt: '2026-07-19', accessLevel: 'internal', sourceType: 'uploaded', uploadedBy: 'USR-002' }
])
...
export const MESSAGE_RECORDS: Message[] = reactive([
  { id: 'MSG-001', entityType: 'project', entityId: 'PRJ-101', projectId: 'PRJ-101', channel: 'internal-note', senderId: 'USR-002', body: 'Reminder: konfirmasi manifest final sebelum keberangkatan H-3.', mentions: ['USR-002'], sentAt: '2026-07-20', deliveryStatus: 'sent' },
  { id: 'MSG-002', entityType: 'project', entityId: 'PRJ-102', projectId: 'PRJ-102', channel: 'client-message', senderId: 'USR-002', body: 'Update: jadwal reschedule sudah dikonfirmasi ke 22–26 Sep 2026, revised itinerary terlampir.', sentAt: '2026-07-09', deliveryStatus: 'delivered', deliveryChannel: 'email' },
  { id: 'MSG-003', entityType: 'project', entityId: 'PRJ-102', projectId: 'PRJ-102', channel: 'client-message', senderId: 'USR-002', body: 'Menginformasikan upgrade kamar ke Suite, mohon konfirmasi approval tambahan biaya.', sentAt: '2026-07-12', deliveryStatus: 'failed', deliveryChannel: 'whatsapp' },
  { id: 'MSG-004', entityType: 'vendor', entityId: 'VND-006', projectId: 'PRJ-103', channel: 'supplier-message', senderId: 'USR-002', body: 'Mohon update status ketersediaan kamar Suite untuk Group C.', sentAt: '2026-07-14', deliveryStatus: 'sent', deliveryChannel: 'email' },
  ...
  { id: 'MSG-006', entityType: 'incident', entityId: 'INC-001', projectId: 'PRJ-103', channel: 'internal-note', senderId: 'USR-002', body: 'Update lapangan: unit cadangan sudah tiba, seluruh traveler kembali on schedule.', mentions: ['USR-002'], sentAt: '2026-07-19', deliveryStatus: 'sent' },
  { id: 'MSG-007', entityType: 'change-request', entityId: 'CR-002', projectId: 'PRJ-102', channel: 'client-message', senderId: 'USR-021', body: 'Konfirmasi permintaan upgrade kamar dari kami, mohon info tambahan biaya yang perlu dibayar.', sentAt: '2026-07-12', deliveryStatus: 'delivered', deliveryChannel: 'whatsapp' },
  { id: 'MSG-008', entityType: 'project', entityId: 'PRJ-104', projectId: 'PRJ-104', channel: 'internal-note', senderId: 'USR-002', body: 'Project baru PRJ-104 dibuat dari Opportunity OPP-008, mohon Ticketing mulai proses awal.', mentions: ['USR-002'], sentAt: '2026-07-24', deliveryStatus: 'queued' },
  /**
...
export const NOTIFICATION_RECORDS: Notification[] = reactive([
  { id: 'NOT-001', userId: 'USR-002', type: 'mention', title: 'Anda disebut dalam catatan project PRJ-101', body: 'Doni Saputra menyebut Anda: "Reminder: konfirmasi manifest final sebelum keberangkatan H-3."', entityType: 'project', entityId: 'PRJ-101', createdAt: '2026-07-20', read: false },
  { id: 'NOT-002', userId: 'USR-002', type: 'escalation', title: 'Incident INC-001 dieskalasi kepada Anda', body: 'Insiden armada mogok (TRN-1034) dieskalasi ke Anda oleh Rudi Hartono.', entityType: 'incident', entityId: 'INC-001', createdAt: '2026-07-19', read: true },
  ...
  { id: 'NOT-004', userId: 'USR-002', type: 'assignment', title: 'Anda ditugaskan pada task baru', body: 'Task "Konfirmasi manifest penumpang" ditugaskan kepada Anda di PRJ-101.', entityType: 'project', entityId: 'PRJ-101', createdAt: '2026-06-24', read: true },
  { id: 'NOT-005', userId: 'USR-002', type: 'mention', title: 'Anda disebut dalam catatan insiden INC-001', body: 'Rudi Hartono menyebut Anda dalam catatan lapangan insiden.', entityType: 'incident', entityId: 'INC-001', createdAt: '2026-07-19', read: false },
  ...
  { id: 'NOT-008', userId: 'USR-002', type: 'message', title: 'Pesan baru pada project PRJ-104', body: 'Doni Saputra mengirim catatan internal baru pada PRJ-104.', entityType: 'project', entityId: 'PRJ-104', createdAt: '2026-07-24', read: false },
  { id: 'NOT-009', userId: 'USR-002', type: 'incident', title: 'Incident baru tercatat pada booking TRN-1034', body: 'Incident INC-001 (armada mogok) tercatat pada booking Anda.', entityType: 'incident', entityId: 'INC-001', createdAt: '2026-07-19', read: true },
  /**
