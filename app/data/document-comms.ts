...
export const MESSAGE_RECORDS: Message[] = reactive([
  ...
  { id: 'MSG-008', entityType: 'project', entityId: 'PRJ-104', projectId: 'PRJ-104', channel: 'internal-note', senderId: 'USR-002', body: 'Project baru PRJ-104 dibuat dari Lead LED-018, mohon Ticketing mulai proses awal.', mentions: ['USR-002'], sentAt: '2026-07-24', deliveryStatus: 'queued' },
  /**
