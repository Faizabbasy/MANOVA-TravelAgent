...
| `/projects/[id]` | Projects | Project Detail | Kontekstual dari All Projects | Ya | Bervariasi per tab (bagian 5) | Kelola 8-tab project workspace | Arsitektur tab `projects/[id]/index.vue` existing | Project Management (shell) → seluruh phase domain (isi) | **Overview selesai (Section 10)** — tab lain (Travelers/Itinerary/Vendors/Finance) masih baseline Foundation, detail penuh menyusul Section 11-15 |
