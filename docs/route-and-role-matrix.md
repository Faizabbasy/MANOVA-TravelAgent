...
| `/projects/[id]` | Projects | Project Detail | Kontekstual dari All Projects | Ya | Bervariasi per tab (bagian 5) | Kelola 8-tab project workspace | Arsitektur tab `projects/[id]/index.vue` existing | Project Management (shell) → seluruh phase domain (isi) | **Overview (Section 10) dan Travelers (Section 11) selesai** — tab lain (Itinerary & Services/Vendors/Finance) masih baseline Foundation, detail penuh menyusul Section 12-15 |
