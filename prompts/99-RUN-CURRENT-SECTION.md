...
`prompts/13-PROMPT-11-TRAVELER-PARTICIPANT.md`

Sebelum mulai:

1. Baca `prompts/01-PROTOKOL-WAJIB.md`.
2. Baca seluruh source of truth dan laporan pekerjaan sebelumnya di folder `docs/`.
...
Kerjakan hanya scope Prompt 11.
...
4. Berhenti dan jangan lanjut ke Prompt 12.